...
if( ! class_exists('Nivo_Image_Slider_Backup') ):

class Nivo_Image_Slider_Backup
{
	public function __construct()
	{
		add_action( 'init', array( $this,'custom_post_type' ) );
		add_action( 'init', array( $this,'custom_taxonomy' ) );
		add_action( 'do_meta_boxes', array( $this,'post_thumbnail_image_box' ) );
	...
	public function post_thumbnail_image_box() {
	    ...
	    add_meta_box('postimagediv', __('Upload Slide Image', 'nivo-image-slider'), 'post_thumbnail_meta_box', 'slider', 'side', 'low');
	}
